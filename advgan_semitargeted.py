...
if __name__ == '__main__':
    ...
    checkpoint_path_f = os.path.join('saved', 'target_models','semitargeted', 'best_%s_mnist.pth.tar'%(model_name))
    ...
    G = Generator()
    checkpoint_name_G = '%s_semitargeted.pth.tar'%(model_name)
    checkpoint_path_G = os.path.join('saved', 'target_models','semitargeted','generators', 'bound_%.1f'%(thres), checkpoint_name_G)
