...
from utils import tsne_plot, cw_l2
...
device = 'cuda'
# t-SNE plot
#image_vec, label_vec = get_adv(test_loader,'cw', device)
#tsne_plot(image_vec, label_vec, 2)

# algorithm timing
#get_time(test_loader, 'cw', device)
...
plt_ours = plt.bar(y_pos + 3*bar_width, l0_ours, bar_width, alpha=0.6, label='Ours')
#
