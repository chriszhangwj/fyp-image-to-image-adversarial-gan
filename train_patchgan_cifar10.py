...
from train_function import train_patchgan_CIFAR10
from test_function import test_baseline_CIFAR10
from utils import tile_evolution, plot_pert, tile_evolution_20, plot_pert_cifar10, tile_evolution_cifar10, GANLoss
...
if __name__ == '__main__':
    ...
    D = PatchGAN(in_channels,8,'basic')
    G = Generator()
    net = ResNet18()
    net.cuda()
    ...
    for epoch in range(epochs):
        acc_train, loss_adv_hist, loss_gan_hist, loss_hinge_hist, loss_g_hist, loss_d_hist, loss_real_hist = train_patchgan_CIFAR10(G, D, net, criterion_adv, criterion_gan, criterion_aux, alpha, beta, gamma, lam, train_loader, optimizer_G, optimizer_D, epoch, epochs, device, num_steps, verbose=True)
        ...
        torch.save({"epoch": epoch+1,
                    ...
                    }, "saved/cifar10/ours/ours_patchgan.pth.tar")
